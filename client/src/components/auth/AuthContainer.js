...
const AuthContainer = ({ title, headerActionName, headerActionPath, headerTitle, children }) => {
    ...
    return (
        <Grid container className={classes.root}>
            ...
            <Grid className={classes.mainContent} container direction="column">
                <AuthHeader actionLabel={headerActionName} actionPath={headerActionPath} title={headerTitle} />
